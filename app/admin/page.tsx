  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl p-5 bg-white border border-slate-200/80 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-3">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-900 tracking-tight tabular-nums">
              ${totalDeposits.toLocaleString('en-US')}{' '}
              <span className="text-xs font-bold text-blue-600">USDT</span>
            </h2>
            <div className="flex items-center gap-2 mt-1 text-[11px] text-slate-500 font-medium">
              <span className="text-emerald-600 font-bold">BSC</span>
              <span>•</span>
                      ...
                      <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td className="py-3.5 px-4 text-right font-bold tabular-nums">
                          <span className={item.amount > 0 ? 'text-emerald-600' : 'text-amber-600'}>
                            {item.amount > 0 ? '+' : ''}{Math.abs(item.amount).toLocaleString('en-US')} USDT
                          </span>
                        </td>
          ...
          <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hot Vault (BSC)</p>
