        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div className="rounded-2xl p-4 card-premium">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] uppercase tracking-wider" style={{ color: '#999' }}>Referrals</span>
            </div>
          ...
          <div className="rounded-2xl p-4 card-premium">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] uppercase tracking-wider" style={{ color: '#999' }}>Earned</span>
            </div>
            <p className="text-2xl font-bold tabular-nums" style={{ color: '#10b981' }}>${(totalEarned ?? 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
        ...
        {totalEarnedL2 > 0 && (
          <div className="rounded-2xl p-4 mb-5 card-premium" style={{ borderLeft: '3px solid #06b6d4' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[10px] uppercase tracking-wider mb-1" style={{ color: '#999' }}>Level 2 Earnings</p>
                <p className="text-xl font-bold tabular-nums" style={{ color: '#06b6d4' }}>${(totalEarnedL2.toLocaleString('en-US', { minimumFractionDigits: 2 }))}</p>
              </div>
